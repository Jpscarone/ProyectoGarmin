...
from sqlalchemy import Boolean, DateTime, ForeignKey, Integer, String, UniqueConstraint, false, true, func
...
class UserAthletePermission(Base):
    ...
    can_sync_garmin: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default=false())
