...
class PlannedSession(Base):
    ...
    strength_focus: Mapped[str | None] = mapped_column(String(50), nullable=True)
    strength_rpe: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    manual_strength_rpe: Mapped[int | None] = mapped_column(Integer, nullable=True)
    manual_strength_focus: Mapped[str | None] = mapped_column(String(50), nullable=True)
    manual_completion_notes: Mapped[str | None] = mapped_column(Text, nullable=True)
