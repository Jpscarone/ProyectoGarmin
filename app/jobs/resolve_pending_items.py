...
from app.services.scheduled_sync_service import run_resolve_pending_job


def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Resolve pending training items.")
    ...
    parser.add_argument("--force", action="store_true", help="Reintenta aunque el pendiente ya haya fallado varias veces.")
...
def main() -> int:
    ...
    db = SessionLocal()
    try:
        summary = run_resolve_pending_job(
            db,
