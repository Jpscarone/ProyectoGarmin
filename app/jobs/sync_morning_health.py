...
from app.services.scheduled_sync_service import run_morning_health_job


def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scheduled Garmin morning health sync.")
    ...
    parser.add_argument("--force", action="store_true", help="Fuerza Health AI aunque ya exista.")
...
def main() -> int:
    ...
    db = SessionLocal()
    try:
        summary = run_morning_health_job(
            db,
